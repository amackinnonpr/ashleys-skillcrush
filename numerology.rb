puts "What is your birthday? Please write in MMDDYYYY"

birthdate = gets

number = birthdate[0].to_i + birthdate[1].to_i + birthdate[2].to_i + birthdate[3].to_i + birthdate[4].to_i + birthdate[5].to_i +
birthdate[6].to_i + birthdate[7].to_i + birthdate[8].to_i + birthdate[9].to_i
...
when 9
	...
	puts "Are you sure your birth number is not 1-9?"
end
